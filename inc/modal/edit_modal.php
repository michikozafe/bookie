 ...
 <div id="edit<?php echo $book["id"]; ?>" class="modal">
    ...
    <div class="modal-body">
      <form action="./controllers/edit_book.php" method="POST" enctype="multipart/form-data">
        ...
        <input type="number" placeholder="Year" min="1" name="year" value="<?php echo $book["year"]; ?>" 
        required>
        <img src="<?= $book['img']; ?>" height="150">
        <input type="file" name="image" value="<?php echo $book["img"]; ?>">
